    ...
    <div className="footer">
      <div className="overlap-group">
        <div className="group">
          ...
          <div className="text-wrapper">Legal Services Offered</div>
          <div className="div">ALD</div>
          ...
          <div className="text-wrapper-13">Reach us</div>
        </div>
        ...
        <div className="frame-3">
          ...
          <div className="text-wrapper-16">Mading, Hyderabad.</div>
        </div>
      </div>
    </div>
  );
